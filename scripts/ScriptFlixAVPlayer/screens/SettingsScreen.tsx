...
import { DanmuScreen } from './DanmuScreen'
  ...
  return (
    <NavigationStack>
      ...
      >
        ...
        <Section header={<Text>弹幕</Text>}>
          <NavigationLink destination={<DanmuScreen />}>
            <VStack alignment="leading" spacing={2}>
              <Text foregroundStyle="#e50914">弹幕设置</Text>
              <Text font="caption2" foregroundStyle="secondaryLabel">
                配置 danmu_api Base URL、透明度与显示位置
              </Text>
            </VStack>
          </NavigationLink>
        </Section>
